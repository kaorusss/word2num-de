...
class TestWord2Num(unittest.TestCase):
    ...
    def test_non_numbers(self):
        # checking robustness to words with hidden numbers or "und"
        self.assertEqual(word_to_number("bäckerei"), None)
        self.assertEqual(word_to_number("kundgebung"), None)
        self.assertEqual(word_to_number("tausendsassa"), None)
        self.assertEqual(word_to_number("sechseck"), None)
        self.assertEqual(word_to_number("servieren"), None)
